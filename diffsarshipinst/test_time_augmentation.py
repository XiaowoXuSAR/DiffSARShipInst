...
class DiffSARShipInstWithTTA(GeneralizedRCNNWithTTA):
    """
        A DiffSARShipInst_ResNet50 with test-time augmentation enabled.
        Its :meth:`__call__` method has the same interface as :meth:`DiffSARShipInst_ResNet50.forward`.
    """
    ...
    def __init__(self, cfg, model, tta_mapper=None, batch_size=3):
        """
            Args:
                cfg (CfgNode):
                model (DiffSARShipInst_ResNet50): a DiffSARShipInst_ResNet50 to apply TTA on.
        ...
        self.max_detection = cfg.MODEL.DiffSARShipInst.NUM_PROPOSALS
    ...
    def _batch_inference(self, batched_inputs, detected_instances=None):
        ...
        Inputs & outputs have the same format as :meth:`DiffSARShipInst_ResNet50.forward`
        """
    ...
    def _merge_detections(self, all_boxes, all_scores, all_classes, shape_hw):
        ...
        num_classes = self.cfg.MODEL.DiffSARShipInst.NUM_CLASSES
