...
from diffsarshipinst import DiffSARShipInstDatasetMapper, add_DiffSARShipInst_config, DiffSARShipInstWithTTA
from diffsarshipinst.util.model_ema import add_model_ema_configs, may_build_model_ema, may_get_ema_checkpointer, EMAHook, \
    apply_model_ema_and_restore, EMADetectionCheckpointer


class Trainer(DefaultTrainer):
    """ Extension of the Trainer class adapted to DiffSARShipInst_ResNet50. """
    ...
    def build_train_loader(cls, cfg):
        mapper = DiffSARShipInstDatasetMapper(cfg, is_train=True)
    ...
    def test_with_TTA(cls, cfg, model):
        ...
        model = DiffSARShipInstWithTTA(cfg, model)
        evaluators = [
            cls.build_evaluator(
